<template>
  <div class="test">
    <div class="test_box">
      ...
      <button @click="clickSub">减</button>
      <p>姓名:{{ student.name }}</p>
      <p>年龄:{{ $store.getters.showCount }}</p>
...
export default {
  ...
  methods: {
    ...
    clickAdd() {
      // 第一种方式使用this.$store.commit
      // this.$store.commit('addCount',2)
      // 第二种方式引入mapMutations,并将该方法映射到methods中直接使用
      // this.addCount(3)
